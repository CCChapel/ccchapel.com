<%@ Control Language="C#" AutoEventWireup="true"  Codebehind="EventBooking.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_ActivityDetails_EventBooking" %>
