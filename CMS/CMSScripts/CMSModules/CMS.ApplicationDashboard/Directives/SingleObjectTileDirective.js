        ...
        function Controller($scope, $compile, $element, $templateCache, $timeout, $window) {
            ...
            */
            this.onClickOutside = function (e) {
                if (_this.getMainDataTileElement(angular.element(e.target)).data('id') !== _this.$scope.tileModel.Id) {
            ...
            */
            this.getMainDataTileElement = function (anyDom) {
                return anyDom.data('singleObjectTile') === 'tile' ? anyDom : angular.element(anyDom.closest('[data-single-object-tile=tile]'));
            };
            /**
